...
b1 =Button(cadre, text="CLIENT",background='#5C4D4D',font=("Inria Sans",30),fg="#ffffff",width=15)
b1.place(y=1, x=2)

b2 =Button(cadre, text="CHAMBRE",background='#5C4D4D',font=("Inria Sans",30),fg="#ffffff",width=15)
b2.place(y=150, x=2)

b3 =Button(cadre, text="SALLE",background='#5C4D4D',font=("Inria Sans",30),fg="#ffffff",width=15)
b3.place(y=290, x=2)

b4 =Button(cadre, text="EMPLOYE",background='#5C4D4D',font=("Inria Sans",30),fg="#ffffff",width=15)
b4.place(y=430, x=2)
